...
Proposed dataset for the Machine Learning 2 project:
...
### Logistic regression
 ...
 As first method we propose  **Logistic Regression** as a supervised Machine Learning approach.
...
### Binary Classifier
 ...
 The proposed classes are **M = malignant** and  **B = benign**. For computataion reasons those values could be encoded as Integers, respectively **0 = M = malignant** or **1 = B = benign**.
